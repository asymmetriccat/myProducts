...
class Products extends Component{
   ...
   constructor(props){
    ...
    render() {
      //  const products = ["learning react", "react pro", "react beginner"]
        const productList = this.products.map(product=> <Product key = {product.productName} data={product}></Product>);
        return (
            <div>
            <li>{productList}</li>
